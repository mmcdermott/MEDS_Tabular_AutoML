...
MEDS_transform-reshard_to_split \
  ...
  "hydra.sweeper.polling_time=5"

# describe codes
echo "Describing codes"
meds-tab-describe \
    "input_dir=$MIMICIV_MEDS_RESHARD_DIR" "output_dir=$OUTPUT_TABULARIZATION_DIR"
...
do
    ...
    worker="range(0,$N_PARALLEL_WORKERS)" \
    hydra/launcher=joblib \
    "input_dir=$MIMICIV_MEDS_DIR" "output_dir=$OUTPUT_TABULARIZATION_DIR" \
